defmodule SurveyWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule SurveyWeb.PageLive do
        use SurveyWeb, :live_view

        on_mount {SurveyWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{SurveyWeb.UserAuth, :ensure_authenticated}] do
